...
from capsnet_plus.layers import ConvCapsLayer, FCCapsLayer
...
class CapsNet(object):
    ...
    def build_arch(self):
        ...
        with tf.variable_scope('Conv1_layer'):
            ...
            # Num of params = 20992
            conv1 = tf.contrib.layers.conv2d(self.X, num_outputs=256, kernel_size=6, stride=1, padding='VALID')
        with tf.variable_scope('PrimaryCaps'):
            ...
            self.pre_vector, self.primary_caps = primary(conv1, kernel_size=6, stride=2)
        ...
        with tf.variable_scope('Decoder'):
            ...
            self.decoded = tf.contrib.layers.fully_connected(fc_2, num_outputs=self.image_size*self.image_size, activation_fn=tf.sigmoid)
    ...
    def model_summary(self):
        ...
        reconstruction_img = tf.reshape(self.decoded, shape=(self.batch_size, self.image_size, self.image_size, 1))
